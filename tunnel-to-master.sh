...
# -L 8000:192.168.165.27:80   → Forward local port 8000 to master port 80 (frontend)
# -L 8080:192.168.165.27:8080 → Forward local port 8080 to master port 8080 (backend)
# -J bsaidi@193.55.163.204    → Jump through bastion
# -N                          → Don't execute remote command (just forward ports)
# -v                          → Verbose mode for debugging

ssh -L 8000:192.168.165.27:80 \
    -L 8080:192.168.165.27:8080 \
