...
REMOTE_STORAGE="/home/ubuntu/mounted_vol/pqdag-storage"
...
ssh $MASTER_HOST "mkdir -p $REMOTE_STORAGE/{rawdata,bindata,outputdata,allocation_results,allocation_temp}"
